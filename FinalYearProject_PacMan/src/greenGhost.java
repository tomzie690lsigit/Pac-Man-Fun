...
public class greenGhost extends Object{

    public greenGhost(int x, int y) {
        super(x, y);
        this.x = x;
        this.y = y;
        initializeGreenGhost();
    }

    private void initializeGreenGhost(){
        loadImage("C:\\Users\\tomzi\\OneDrive\\Desktop\\PAC_MAN_MINE\\FinalYearProject_PacMan\\src\\Images\\Green_ghost.png");
        getImageDimensions();
    }
